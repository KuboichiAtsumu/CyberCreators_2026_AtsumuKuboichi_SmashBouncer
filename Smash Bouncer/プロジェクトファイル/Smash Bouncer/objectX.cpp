...
void CObjectX::DrawOutLine()
{
	...
	//各パーツモデルの拡大率を反映
	D3DXMatrixScaling(&mtxWorld, OUTLINE_SCALE, OUTLINE_SCALE, OUTLINE_SCALE);//元のパーツより大きく設定
	pDevice->SetTransform(D3DTS_WORLD, &mtxWorld);
	...
	outlineMaterial.Diffuse.r = 0.0f;
	outlineMaterial.Diffuse.g = 0.0f;
	outlineMaterial.Diffuse.b = 0.0f;
